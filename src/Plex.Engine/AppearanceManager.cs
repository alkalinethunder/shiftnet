...
{
    // Provides functionality for managing windows within Shiftnet.
    public static class AppearanceManager
    {
        ...
        // Provides a list of all open Shiftnet windows.
    ...
    // Provides the base functionality for a typical Shiftnet window border, what did you expect
