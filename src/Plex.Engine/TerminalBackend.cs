...
{
    /// <summary>
    /// Backend for the Shiftnet terminal.
    /// </summary>
    public static class TerminalBackend
    {
        ...
        /// <summary>
        /// Sets the shell override string to the specified value. Empty string or <see cref="null"/> to use the default Shiftnet string. 
        /// </summary>
        ...
        /// <summary>
        /// Invokes a Shiftnet terminal command.
        /// </summary>
        ...
        /// Invokes a Shiftnet terminal command.
        /// </summary>
        /// <param name="text">The full command text in regular Shiftnet syntax</param>
        /// <param name="isRemote">Whether the command should be sent through Remote Terminal Session (RTS).</param>
