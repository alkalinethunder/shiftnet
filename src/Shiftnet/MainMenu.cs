    ...
    public class MainMenu : Control
    {
        ...
        public MainMenu()
        {
            ...
            _terminal.StartShell((stdout, stdin) =>
            {
                ...
                _console.SetColors(Plex.Objects.ConsoleColor.White, Plex.Objects.ConsoleColor.Black);
                _console.WriteLine("Peacegate v9.4.7");
                _console.SetBold(false);
                _console.SetColors(Plex.Objects.ConsoleColor.Black, Plex.Objects.ConsoleColor.White);
                _console.WriteLine("");
                ...
                if(_gameStarted == null)
                {
                    _gameStarted = (ctx) =>
                    {
                        if(SaveSystem.IsSandbox == false)
                        {
                            ...
                            ctx.SetColors(Plex.Objects.ConsoleColor.Black, Plex.Objects.ConsoleColor.White);
                            Thread.Sleep(2000);
                        }
                        ...
                        Plex.Engine.Desktop.InvokeOnWorkerThread(() =>
                        {
                            ...
                            Plex.Engine.Desktop.CurrentDesktop.Show();
                            Plex.Engine.Desktop.CurrentDesktop.SetupDesktop();
                        });
                    };
        ...
        protected override void OnLayout(GameTime gameTime)
        {
            ...
            _legalBullshit.Alignment = Plex.Engine.GUI.TextAlignment.Middle;
            ...
            switch (_wgState)
            {
                case 0:
                    ...
                    if(_wgFade >= 1.0F)
                    {
                        ...
                        _console.SetColors(Plex.Objects.ConsoleColor.Black, Plex.Objects.ConsoleColor.Blue);
                ...
                case 4:
                    ...
                    {
                        _console.Write(" The ");
                        _console.SetColors(Plex.Objects.ConsoleColor.Black, Plex.Objects.ConsoleColor.Green);
                        _console.SetBold(true);
            ...
            if (e.Key == Microsoft.Xna.Framework.Input.Keys.Enter)
                if (_wgState == 7)
                {
                    if (_enterPressed == false)
                    {
                        ...
                        Plex.Engine.Infobox.Show("Information", "This game uses cloud save features. Do not switch off your system while the cloud icon is displayed.", () =>
                        {
                            _wgState++;
