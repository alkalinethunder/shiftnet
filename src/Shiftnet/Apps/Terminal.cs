...
Buffer requires complete redraw: {_resized}";
                ...
                gfx.DrawString(text, 0, 0, Microsoft.Xna.Framework.Color.White, new System.Drawing.Font("Monda", 9F), TextAlignment.TopLeft, Width, Plex.Engine.TextRenderers.WrapMode.Words);
            }
            gfx.Batch.End();
